...
export const PrcieData = [
  {
    ...
    plan: "MONTHLY",
    imgSrc:
      "https://res.cloudinary.com/dsq5spft3/image/upload/v1689404278/dumbbell_de55ek.png",
    planContent: [
  ...
  },
  {
    ...
    plan: "QUARTERLY",
    imgSrc:
      "https://res.cloudinary.com/dsq5spft3/image/upload/v1689404278/hand-grip_xcn6lk.png",
    planContent: [
      " Unlimited Access to Home Club",
      " Free Fitness Training",
      " Free training session with a Club",
  ...
  },
  {
    ...
    plan: "HALFLY",
    imgSrc:
      "https://res.cloudinary.com/dsq5spft3/image/upload/v1689183960/Demo%20Test/Revamp/Project_qe0oeb.png",
    planContent: [
      " Unlimited Access to Home Club",
      " Free Fitness Training",
      " Free training session with a Club",
  ...
  },
  {
    ...
    plan: "YEARLY",
    imgSrc:
      "https://res.cloudinary.com/dsq5spft3/image/upload/v1689404278/boxing-glove_nlfkqy.png",
    planContent: [
      " Unlimited Access to Home Club",
      " Free Fitness Training",
      " Free training session with a Club",
